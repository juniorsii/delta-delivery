...
<body class="is-preload">
    ...
    <div id="wrapper">
        ...
        <section class="intro" id="home">
            <header>
                <h1>Entregue essa ideia</h1>
                <p>Conectando pessoas a maior rede de entregadores de Parnaíba</p>
                <ul class="actions">
                    <li>
                        <a href="https://api.whatsapp.com/send?phone=5586995596185&text=Ol%C3%A1%2C%20preciso%20de%20um%20entregador%20com%20urg%C3%AAncia!" target="_blank" class="button white pulse">quero um motoboy agora!</a>
                    </li>
                </ul>
                <ul class="actions">
                    <li>
            ...
            <div class="content">
                <span class="image fill" data-position="center"><img src="images/app.jpg" alt="Delta Delivery MotoBoy" /></span>
            </div>
        </section>
            ...
            <div class="content">
                ...
                <ul class="feature-icons">
                    ...
                    <li class="icon fa-get-pocket">
                        <h3>seguro</h3>
                        Além de apólice de seguro, verificamos a veracidade das
                        informações e antecedentes dos entregadores, a fim de garantir
                        total segurança no processo de coleta e entrega de remessas.
                    </li>
        ...
        <section>
            ...
            <div class="content">
                ...
                <section>
                    ...
                    <div class="content">
                        <img src="./images/clientes/lac.jpg" alt="Lac Lanche" width="120" />
                        <img src="./images/clientes/acai.jpg" alt="Açaí Original" width="120" />
                        <img src="./images/clientes/amo-pizza.jpg" alt="Amo Pizza" width="120" />
                        <img src="./images/clientes/atelie.jpg" alt="Atelie do Sabor" width="120" />
                        <img src="./images/clientes/js-burguer.jpg" alt="JS Burguer" width="120" />
                        <img src="./images/clientes/grillados.jpg" alt="Grillados" width="120" />
                        <img src="./images/clientes/lunatico.jpg" alt="Lunático" width="120" />
                        <img src="./images/clientes/php-prime.jpg" alt="PHP Prime" width="120" />
                        <img src="./images/clientes/super-acai.jpg" alt="Super Açaí" width="120" />
                        <img src="./images/clientes/vila-burguer.jpg" alt="Vila Burguer" width="120" />
                    </div>
                </section>
            </div>
        </section>

        <!-- Section Solicite um entregador -->
        <section id="solicitar">
            <header>
                <h2>Solicite agora mesmo um entregador</h2>
            </header>
            <div class="content">
                <p>
                ...
                <a href="https://api.whatsapp.com/send?phone=5586995596185&text=Ol%C3%A1%2C%20gostaria%20de%20um%20or%C3%A7amento%20para%20minha%20empresa!" target="_blank" class="button large">quero um orçamento</a>
            </div>
        </section>
